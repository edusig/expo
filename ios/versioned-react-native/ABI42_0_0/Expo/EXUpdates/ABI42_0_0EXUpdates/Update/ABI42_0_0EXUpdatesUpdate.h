...
@property (nonatomic, strong, readonly) ABI42_0_0EXManifestsManifest *rawManifest;
...
+ (ABI42_0_0EXManifestsManifest *)manifestForManifestJSON:(NSDictionary *)manifestJSON;
