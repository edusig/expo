...
class UpdateManifestMetadataTest {
  ...
  fun testManifestFilters_OverwriteAllFields() {
    ...
    val updateManifest1: UpdateManifest = NewUpdateManifest.fromRawManifest(manifest!!, response1, config!!)
    ...
    val updateManifest2: UpdateManifest = NewUpdateManifest.fromRawManifest(manifest!!, response2, config!!)
